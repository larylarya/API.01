...
-- Cria o banco de dados com a atenção à tabela de caracteres. 
CREATE DATABASE db_items CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;

-- Selecionar o banco de dados.
USE db_items;

-- Cria tabela 'user' conforme modelo. 
CREATE TABLE user (
...
('Marineuza Sililiano', 'mari@neuza.com', '123', '2000-08-09'),
('Dinho Souza', 'dinho@souza.com', '123', '1979-08-12');
